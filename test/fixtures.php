...
{
    public $interface;
    public function __construct(DelegatableInterface|null $i = null)
    {
        $this->interface = $i;
    }
}
...
{
    public $dependency;
    public function __construct(\StdClass|null $instance = null)
    {
...
{
    public $injector;
    public function __construct(\DI\Injector $injector)
    {
